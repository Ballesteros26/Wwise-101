...
namespace QuestSystem
{
    ...
    public class QuestGiver : InteractableNPC
    {
        ...
        private bool questlineCompleteEventActive = false;
        ...
        {
            if (questlineCompleteEventActive) 
            {
                Quests[currentQuestIdx].OnQuestComplete -= AdvanceQuestLine;
            }
            StopAllCoroutines();
        }
        ...
        private IEnumerator QuestInit(int questIdx)
        {
            ...
            questlineCompleteEventActive = true;
        ...
        public void AdvanceQuestLine(Quest quest)
        {
            ...
            questlineCompleteEventActive = false;
