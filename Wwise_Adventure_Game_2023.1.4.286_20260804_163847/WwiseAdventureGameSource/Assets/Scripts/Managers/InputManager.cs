...
public class InputManager : MonoBehaviour
{
    ...
    private void AddWwiseMotion() {
        AkOutputSettings outputSettings = new AkOutputSettings("Wwise_Motion",0);
        AkSoundEngine.AddOutput(outputSettings);
    }
