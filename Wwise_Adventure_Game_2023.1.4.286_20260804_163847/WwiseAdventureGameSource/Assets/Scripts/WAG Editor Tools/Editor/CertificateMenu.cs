...
[MenuItem(NameOfMenu+"/Website",false, priority_website)]
    ...
    ///////////////////////// LESSON SCENES
    [MenuItem(NameOfMenu + "/Certification/251/Lesson 1/Special Case SoundBanks", false, priority_certification)]
    public static void OpenScene_251_L1_12()
    {
        EditorSceneManager.OpenScene(Cert251_SceneFolder + "Lesson 1A - Title Screen" + UnityType);
        AdjustCamera();
    }
    ...
    {
        EditorSceneManager.OpenScene(Cert251_SceneFolder + "Lesson 2.0 - Main Scene" + UnityType);
        AdjustCamera();
    }
    ...
    {
        EditorSceneManager.OpenScene(Cert251_SceneFolder + "Lesson 5.0 - Main Scene" + UnityType);
        AdjustCamera();
    }
    ...
    [MenuItem(NameOfMenu + "/Certification/251/Lesson 7/Main Scene", false, priority_certification)]
    public static void OpenScene_251_L7_X()
    {
        EditorSceneManager.OpenScene(Cert251_SceneFolder + "Lesson 7.0 - Main Scene" + UnityType);
        AdjustCamera();
    }
