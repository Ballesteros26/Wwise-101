...
#pragma once
/// \file
/// Registers the Wwise Impacter plugin automatically.
...
/// <br><b>Wwise plugin name:</b>  Wwise Impacter
/// <br><b>Library file:</b> AkImpacterSource.lib

AK_STATIC_LINK_PLUGIN(AkImpacter)
